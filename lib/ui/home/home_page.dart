...
import 'package:helios_app_flutter_x/viewmodels/home/home_page_view_model.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, HomePageViewModel>(
      ...
      onInit: (store) {
        store.dispatch(ChangeAppBarTitleAction(store.state.selectedCinema.name));
        store.dispatch(ChangeVisibilityOfChangeCinemaButtonAction(isVisible: true));
      },
      builder: (context, viewModel) => Scaffold(
        ...
        body: WillPopScope(
          ...
          child: viewModel.pages.isEmpty || viewModel.getSelectedPageIndex() >= viewModel.pages.length
              ? Container()
              : PageView(
